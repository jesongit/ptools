...
public class MyDownloader {
    ...
    public static void main(String[] args) throws IOException {
        ...
        new MyDownloader(url, "D:/ls-lR.gz").get();
    }

    public MyDownloader(String Url, String localPath) throws MalformedURLException {
        this.url = new URL(Url);
        this.localFile = new File(localPath);
    }

    public MyDownloader(String Url, String localPath,
